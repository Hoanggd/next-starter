...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-background to-background-secondary">
      ...
      {/* Footer */}
      <footer className="border-t bg-background-secondary/50 py-12 mt-20">
        <div className="px-4 mx-auto max-w-7xl text-center">
          ...
          <div className="flex justify-center gap-6 text-sm text-muted-foreground">
            <Link href="/docs/introduction" variant="link">
              Docs
            </Link>
            <Link
              href="https://github.com"

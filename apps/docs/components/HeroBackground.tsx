export function HeroBackground() {
  return (
    <div className="opacity-70 pointer-events-none absolute inset-0 z-0 grid h-full w-full -rotate-45 transform select-none grid-cols-2 gap-10 md:grid-cols-4">

...
> "The best code is no code at all. The second best code is simple, stupid code." - [Cognitive Load Theory](https://github.com/zakirullin/cognitive-load)
...
- **Keep functions small** - A function should do one thing well, not many things poorly
...
## Embrace Duplication Over Wrong Abstractions
...
// ✅ Server components or data fetching libraries
...
- **Debuggable** - You can see the app state in the browser
...
- **User authentication** (but consider HTTP-only cookies)
- **Real-time data** that doesn't affect navigation
...
4. **URL as state** - Make app state visible and shareable

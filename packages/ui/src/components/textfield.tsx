  ...
  return (
    <AriaInput
      className={composeRenderProps(className, (className) =>
        cn(
          "shadow-sm flex h-9 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground",
          /* Disabled */

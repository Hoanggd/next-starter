  ...
  return (
    ...
    >
      ...
      <FieldGroup>
        <SearchIcon
          aria-hidden
          className="w-4 h-4 ml-2 text-gray-500 dark:text-gray-400 forced-colors:text-[ButtonText] group-disabled:text-gray-200 dark:group-disabled:text-gray-600 forced-colors:group-disabled:text-[GrayText]"
        />
